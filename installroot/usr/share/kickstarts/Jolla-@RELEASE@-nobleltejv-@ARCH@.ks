# DisplayName: Jolla nobleltejv/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: nobleltejv
# DeviceVariant: nobleltejv
# Brand: Jolla
...
repo --name=adaptation-common-nobleltejv-@RELEASE@ --baseurl=https://releases.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-common/@ARCH@/
repo --name=adaptation-community-common-nobleltejv-@RELEASE@ --baseurl=https://repo.sailfishos.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
patterns-sailfish-device-configuration-nobleltejv
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/nobleltejv
